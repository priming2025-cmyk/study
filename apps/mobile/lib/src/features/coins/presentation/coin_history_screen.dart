    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<CoinEventEntry>>(
        ...
        builder: (context, snapshot) {
          ...
          final todaySum = today.fold<int>(0, (s, e) => s + e.coins);

          return ListView(
            padding: const EdgeInsets.all(16),
            children: [
              _BalanceHeader(future: const SessionRepository().fetchCoinBalance()),
              ...
              if (sessionsMap.isEmpty)
                Padding(
                  ...
                  child: Text(
                    '세션 종료 시 받은 코인만 묶입니다. 보너스 코인은 한 행으로 전체 목록에 표시돼요.',
                    style: Theme.of(context).textTheme.bodySmall?.copyWith(
            ...
            child: Row(
              children: [
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('보유 코인', style: Theme.of(context).textTheme.labelLarge),
                    Text(
                      '$b',
