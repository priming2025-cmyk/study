        ...
        child: InkWell(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(14),
              border: Border.all(
                color: selected ? color : cs.outlineVariant.withValues(alpha: 0.6),
                width: selected ? 2 : 1,
              ),
            ),
            child: Row(
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        hasSchedule
                            ? '${DateFormat('HH:mm').format(item.scheduledStartAt!.toLocal())} · ${formatPlanMinutes(actualMin)}/${formatPlanMinutes(targetMin)}'
                            : '${formatPlanMinutes(actualMin)}/${formatPlanMinutes(targetMin)}${item.isDone ? ' · 완료' : ''}',
                ...
                IconButton(
                  ...
                  icon: Icon(
                    ...
                    size: 22,
                    color: hasSchedule ? cs.primary : cs.onSurfaceVariant,
                  ),
